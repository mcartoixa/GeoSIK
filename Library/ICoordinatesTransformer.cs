...
namespace GeoSik
{
    ...
    ////////////////////////////////////////////////////////////////////////////
    ///
    /// <summary>Interface implemented by a coordinates transformer.</summary>
    ///
    ////////////////////////////////////////////////////////////////////////////
    ...
    public interface ICoordinatesTransformer
    {
        ...
        double[] Convert(double[] coordinates);
        /// <summary>Transforms all the specified coordinates.</summary>
        /// <param name="coordinates">The coordinates to transform.</param>
        /// <returns>The transformed coordinates.</returns>
        IEnumerable<double[]> Convert(IEnumerable<double[]> coordinates);
    }
}
