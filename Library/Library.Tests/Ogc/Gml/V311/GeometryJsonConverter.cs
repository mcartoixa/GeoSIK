...
namespace GeoSik.Ogc.Gml.V311.Tests
{
    ...
    public class GeometryJsonConverterTests
    {
        ...
        [InlineData("MULTIPOINT ((100 0), (101 1))", "{\"type\":\"MultiPoint\",\"bbox\":[100.0,0.0,101.0,1.0],\"coordinates\":[[100.0,0.0],[101.0,1.0]]}")]
        [InlineData("LINESTRING (100 0, 101 1)", "{\"type\":\"LineString\",\"coordinates\":[[100.0,0.0],[101.0,1.0]]}")]
        [InlineData("MULTILINESTRING ((100 0, 101 1), (102 2, 103 3))", "{\"type\":\"MultiLineString\",\"bbox\":[100.0,0.0,103.0,3.0],\"coordinates\":[[[100.0,0.0],[101.0,1.0]],[[102.0,2.0],[103.0,3.0]]]}")]
        [InlineData("POLYGON ((100 0, 101 0, 101 1, 100 1, 100 0))", "{\"type\":\"Polygon\",\"bbox\":[100.0,0.0,101.0,1.0],\"coordinates\":[[[100.0,0.0],[101.0,0.0],[101.0,1.0],[100.0,1.0],[100.0,0.0]]]}")]
        [InlineData("POLYGON ((100 0, 101 0, 101 1, 100 1, 100 0), (100.2 0.2, 100.8 0.2, 100.8 0.8, 100.2 0.8, 100.2 0.2))", "{\"type\":\"Polygon\",\"bbox\":[100.0,0.0,101.0,1.0],\"coordinates\":[[[100.0,0.0],[101.0,0.0],[101.0,1.0],[100.0,1.0],[100.0,0.0]],[[100.2,0.2],[100.8,0.2],[100.8,0.8],[100.2,0.8],[100.2,0.2]]]}")]
        [InlineData("MULTIPOLYGON (((-6 41, 10 41, 10 52, -6 52, -6 41)), ((-70 10, -60 10, -60 20, -70 20, -70 10)), ((-60 0, -50 0, -50 10, -60 10, -60 0)), ((60 -20, 50 -20, 50 -30, 60 -30, 60 -20)))", "{\"type\":\"MultiPolygon\",\"bbox\":[-70.0,-30.0,60.0,52.0],\"coordinates\":[[[[-6.0,41.0],[10.0,41.0],[10.0,52.0],[-6.0,52.0],[-6.0,41.0]]],[[[-70.0,10.0],[-60.0,10.0],[-60.0,20.0],[-70.0,20.0],[-70.0,10.0]]],[[[-60.0,0.0],[-50.0,0.0],[-50.0,10.0],[-60.0,10.0],[-60.0,0.0]]],[[[60.0,-20.0],[50.0,-20.0],[50.0,-30.0],[60.0,-30.0],[60.0,-20.0]]]]}")]
