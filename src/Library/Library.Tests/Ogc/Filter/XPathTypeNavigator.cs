...
namespace OgcToolkit.Ogc.Filter.Tests
{
    ...
    public class XPathTypeNavigatorTests
    {
        ...
        //[Theory]
        //[InlineData(typeof(Csw202.IBriefRecord), "dc:identifier")]
        //[InlineData(typeof(Csw202.IBriefRecord), "dc:title")]
        //[InlineData(typeof(Csw202.IBriefRecord), "csw:Record")]
        //[InlineData(typeof(Csw202.IBriefRecord), "/csw:Record")]
        //[InlineData(typeof(Csw202.IBriefRecord), "/csw:Record/dc:title")]
        ...
        //[Theory]
        //[InlineData(typeof(Csw202.IBriefRecord), "dc:dummy")]
        //[InlineData(typeof(Csw202.IBriefRecord), "csw:dummy")]
        //[InlineData(typeof(Csw202.IBriefRecord), "/csw:dummy")]
        //[InlineData(typeof(Csw202.IBriefRecord), "/csw:Record/dc:dummy")]
