...
namespace GeoSik
{
    ...
    public class ReversedGeometrySinkTests:
        IDisposable
    {

        public ReversedGeometrySinkTests()
        {
        ...
        [InlineData("LineString ( 10 10, 20 20, 30 40)", "LINESTRING (30 40, 20 20, 10 10)")]
        [InlineData("LineString Empty", "LINESTRING EMPTY")]
        [InlineData("Polygon ((10 10, 20 15, 20 20, 10 20, 10 10))", "POLYGON ((10 10, 10 20, 20 20, 20 15, 10 10))")]
        ...
        [InlineData("MultiLineString ( (10 10, 20 20), (15 15, 30 15) )", "MULTILINESTRING ((20 20, 10 10), (30 15, 15 15))")]
        [InlineData("MultiLineString Empty", "MULTILINESTRING EMPTY")]
        [InlineData("MultiPolygon ( ((10 10, 20 15, 20 20, 10 20, 10 10)), ((60 60, 70 70, 80 60, 60 60 )) )", "MULTIPOLYGON (((10 10, 10 20, 20 20, 20 15, 10 10)), ((60 60, 80 60, 70 70, 60 60)))")]
        [InlineData("MultiPolygon Empty", "MULTIPOLYGON EMPTY")]
        [InlineData("GeometryCollection ( POINT (10 10), POINT (30 30), LINESTRING (15 15, 20 20) )", "GEOMETRYCOLLECTION (POINT (10 10), POINT (30 30), LINESTRING (20 20, 15 15))")]
