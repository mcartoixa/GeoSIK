...
namespace GeoSik.Ogc.SimpleFeature.WktAst
{
    ...
    ////////////////////////////////////////////////////////////////////////////
    ///
    /// <summary>AST node for the container of a series of line strings.</summary>
    ///
    ////////////////////////////////////////////////////////////////////////////

#pragma warning disable 3009
    public class MultiLineStringNode:
        GeometryNode,
        IGeometryTap
    {
        ...
        public override void Init(AstContext context, ParseTreeNode treeNode)
        {
            ...
            if (treeNode.ChildNodes.Count>1)
            {
                ...
                if (series!=null)
                    ...
                    {
                        var s=AddChild("linestring", n) as SeriesNode;
                        if (s!=null)
                            _PointSeries.Add(s);
                    }
            }
        ...
        private List<SeriesNode> _PointSeries=new List<SeriesNode>();
    }
