...
:: -------------------------------------------------------------------
:BUILD
.nuget\NuGet.exe install ".nuget\packages.config" -o packages -source "https://api.nuget.org/v3/index.json" -source "http://CHANTIERS.hq.isogeo.fr/nuget/nuget/" -source "%LocalAppData%\NuGet\Cache"
